...
public class AboutUs extends JFrame{
    ...
    public AboutUs() {
        ...
        JLabel l6 = new JLabel("Created by :Saransh");
        ...
        JLabel l8 = new JLabel("Contact : sorryforlatesubmission@gmail.com");
        l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l8.setBounds(70, 290, 600, 34);
        contentPane.add(l8);

        JLabel l9 = new JLabel("Education - B.hons (Computer Science)");
        l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
        l9.setBounds(70, 320, 600, 34);
        contentPane.add(l9);


        JLabel l10 = new JLabel("Phone - +977 9868333333");
